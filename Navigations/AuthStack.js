...
const AuthStack = () => {
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen options={{headerShown:false}} name="VerifyAccount" component={VerifyAccount} />
      <Stack.Screen options={{headerShown:false}} name="Congrats" component={Welcome}/>
    </Stack.Navigator>
  );
};
